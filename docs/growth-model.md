...
| Fungal initial biomass and free pools | `0.0001 g`; `0.00005 g C`; `0.00013 mg P` | Living external mycelium in an early-established fixture, deliberately below the approximately `3–17 mg` mature external-mycelium measurements in *R. irregularis* root-organ microcosms ([Sun et al. (2024)](https://doi.org/10.1007/s00572-024-01154-8)). This is not inoculum, colonized-root mass, or a spore mass. Each free pool contains one structural-biomass equivalent. |
...
| Plant and fungal $\kappa_P$ | `0.001 mg P g⁻¹ d⁻¹` | Interpreted for both organisms as irreversible free-P losses, not physiological maintenance or structural immobilisation. This shared value is an explicit model-policy choice that places both partners under the same small free-P-loss burden; it is not a direct measurement for either organism. Structural P is represented only by $\gamma_P$. |
