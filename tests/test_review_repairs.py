...
@pytest.mark.parametrize(
    ...
    (
        ...
        (PlantTraits, "biomass_cap", -1.0),
        (PlantTraits, "biomass_cap", float("nan")),
        (PlantTraits, "biomass_cap", float("inf")),
        (PlantTraits, "biomass_observation_reference", 0.0),
        (PlantTraits, "biomass_observation_reference", -1.0),
        (PlantTraits, "biomass_observation_reference", float("nan")),
        (PlantTraits, "biomass_observation_reference", float("inf")),
